      ...
      {active !== id ? (
        ...
        <div className="absolute bottom-0 p-8 max-sm:py-4 justify-start w-full flex-col bg-[rgba(0,0,0,0.5)] rounded-b-[24px] ">
          <div className="flex grid-cols-2 justify-between">
            <p
              className={`${styles.flexCenter} h-[50px] max-sm:h-[40px] rounded-[15px] glassmorphism mb-[10px] max-sm:mb-2 text-[18px] leading-[20px] px-4`}
            >
              {category === "Research" ? (
          ...
          <h2 className="mt-[24px] max-sm:mt-[12px] font-bold  max-sm:text-[20px] text-[24px] text-white ">
            {t(title)}
          </h2>
          <p className="font-normal max-sm:text-[12px] text-[16px] leading-[20px] text-white/80">
            {t(tags)}
          </p>
